...
namespace SignalR.Sample.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly IHubContext<DeathlyHallowsHub> _deathlyHubContext;
        private readonly IHubContext<OrderHub> _orderHubContext;
        private readonly ApplicationDbContext _context;

        public HomeController(
            ILogger<HomeController> logger,
            IHubContext<DeathlyHallowsHub> deathlyHubContext,
            IHubContext<OrderHub> orderHubContext,
            ApplicationDbContext context)
        {
            _logger = logger;
            _deathlyHubContext = deathlyHubContext;
        ...
        public async Task<IActionResult> DeathlyHallows(string type)
        {
            ...
            await _deathlyHubContext.Clients.All.SendAsync("updateDeathlyHallowsCount",
